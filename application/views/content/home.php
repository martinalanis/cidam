		...
		<div class="col s12 m4">
			...
			<div class="row">
				<div id="soluciones-integrales" class="col s12">
					<div class="card no-margin z-depth-0" style="border-radius: 6px;">
						<div class="card-image" style="border-radius: 6px 6px 0px 0px;">
							<img src="<?php echo $img_path; ?>gallery/solutions.jpg">
							<span class="card-title center-align" style="left: 0; right: 0;">Soluciones Integrales</span>
						</div>
						<div class="card-content center-align" style="border-radius: 0px 0px 6px 6px; padding-bottom: 0px;">
							...
							<div class="card-action center-align">
								<a href="#" class="black-text no-margin">Conoce mas</a>
							</div>
						</div>
